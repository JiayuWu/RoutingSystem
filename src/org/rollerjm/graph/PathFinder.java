...
public class PathFinder {
    ...
    public int getShortestWeightDistance(Object start, Object destination, int timeindex) {
        return dijkstra.getShortestWeightDistance(start, destination, timeindex);
    }
     ...
     * @return
     */
    public Path getShortestPath(String start, String destination, int timeindex) {
        return dijkstra.getShortestPath(start, destination, timeindex);
    }
    
//    /**
//     * try to get "from one to all"
//     */
//    public Path getShortestPath(String start, int timeindex){
//        return dijkstra.getShortestPath(start, timeindex);
//    }
...
//     * @param path
//     */
//    private void searchDistance(Path path, int timeindex, int[][][] linkweights) {
//        Object lastVertex = path.getLast();
//
//        // Stop condition : If the path distance is > maxDistance
//        if (graph.getEdgeWeight(path) + dijkstra.getShortestWeightDistance(lastVertex, destination, timeindex, linkweights) <= maxDistance) {
//
//            Iterator iterAdjacents =graph.getAdjacentVertices(lastVertex);
//            while (iterAdjacents.hasNext()) {
//                Object adjacentVertex = iterAdjacents.next();
...
//                }
//
//                searchDistance(newPath, timeindex, linkweights);
//            }
//        } // end if Stop Condition
//    }
}
